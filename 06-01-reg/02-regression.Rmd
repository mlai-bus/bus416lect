...
**Forward Selection** starts with just the intercept and variables with the loweest p value are added sequentially. The algorithm stops when the contribution of additional predictors is not statistically significant. The main disadvantage of this method is that the algorithm will miss pairs or groups of predictors that perform very well together but perform poorly as single predictors.
