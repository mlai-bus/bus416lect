...
We see that both these variables are highly correlated. Correlation is `r round(cor(df1.sm)[1,2],2)`. If we consider the variance of each predictor as the information conveyed by it, we can get the relative information by as the variance/total.variance.
...
This following code chunk is in case you want to run this on your computers.
