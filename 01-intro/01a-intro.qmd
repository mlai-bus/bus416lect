...
x[index] # This is rearrange x based on the index

rank(x) #rank tells us where exactly to the elements belong in their relative position

rank(-x)
# so to find the countries with worst life expectancy

ind <- order(life.expt$lifeExp) # This gives us the ordering of life exp
