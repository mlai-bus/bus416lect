...
According to Hadley Wickham, a plot or a graphs is defined by the following components:
...
Jittering adds some randomness to the data which helps with visualization. Suppose we want to colletct g2, g3 and g5, with g2 and g3 side-by-side with g5 in the bottom
